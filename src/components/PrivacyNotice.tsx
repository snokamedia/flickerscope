...
export function PrivacyNotice() {
  return (
    <div className="mt-8 flex flex-col items-center gap-3 text-center text-[11px] text-text-dim">
      <div className="flex items-center gap-2">
        <ShieldCheck className="size-3.5" />
        <span>
          100% client side — <strong className="text-text-muted">no video is uploaded</strong> to any server.
          Reloading resets all data.
        </span>
      </div>
